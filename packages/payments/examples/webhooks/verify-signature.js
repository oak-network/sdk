...
const {
  ...
  parseWebhookPayload,
} = require("../../dist/utils/webhookVerification");
...
const { parseWebhookPayload } = require('@oaknetwork/payments-sdk');
...
app.listen(3000);
  ...
  console.log(
    "  ✓ Use timing-safe comparison (built into verifyWebhookSignature)",
  );
